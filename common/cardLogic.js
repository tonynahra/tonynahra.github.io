...
$(document).ready(function () {
    ...
    $('body').on('click', '.modal-prev-btn', function() { $(this).blur(); stopSlideshow(); if (currentCardIndex > 0) loadModalContent(currentCardIndex - 1); });
    $('body').on('click', '.modal-next-btn', function() { $(this).blur(); if (currentCardIndex < currentCardList.length - 1) loadModalContent(currentCardIndex + 1); else stopSlideshow(); });
