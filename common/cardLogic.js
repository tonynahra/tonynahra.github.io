        ...
        .then(() => {
            $.getJSON(jsonUrl, function(data) {
                ...
                new Tabulator("#" + tableId, {
                    data: tableData, layout: "fitColumns", pagination: "local", paginationSize: 15,
...
window.loadChessGame = function(loadUrl, $modal, $modalContent) { 
    ...
    // HIDE HEADER BUTTONS IN CHESS MODE TO PREVENT CONFLICT
    $('.modal-prev-btn, .modal-next-btn').hide();
